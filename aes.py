...
# 05/04/2022
# Práctica: Cifrado de AES RIJNDAEL
############################################################
...
def rijndael():
  ...
  entradaMatrix = toMatrix(entrada)
  subClave = []
  ...
  # Imprimo la iteración 0
  print ("\nR0 (Subclave = ", end = '')
  for i in range(4):
    for j in range(4):
      print(subClave[0][j][i][2:].zfill(2), end='')
  print(') = ', end='')
  
  print('\naddRoundKey')
  print(addRoundKey(entradaMatrix, toMatrix(clave)))
  

  for i in range(4):
    for j in range(4):
      print(entradaMatrix[j][i][2:].zfill(2), end='')
  print()

  # Inicia el bucle de 9 iteraciones (SubBytes, ShiftRow, MixColumn y AddRoundKey)
  for item in range(1, 10):
    print('\nsubBytes(entradaMatrix)')
    print(subBytes(entradaMatrix))
    print('\nshiftRow(entradaMatrix)')
    print(shiftRow(entradaMatrix))
    print('\nmixColumn(entradaMatrix)')
    print(mixColumn(entradaMatrix))
    print('addRoundKey(entradaMatrix, subClave[item])')
    print(addRoundKey(entradaMatrix, subClave[item]))

    print ('R' + str(item) + ' (Subclave = ', end = '')
    for i in range(4):
      for j in range(4):
        print(subClave[item][j][i][2:].zfill(2), end='')
    print(') = ', end='')
  ...
  for i in range(4):
    for j in range(4):
      print(subClave[10][j][i][2:].zfill(2), end='')
  print(') = ', end='')
  for i in range(4):
    for j in range(4):
      print(entradaMatrix[j][i][2:].zfill(2), end='')
