...
def menu():
  ...
  # clave = 'e0:99:a3:97: 3c:53:eb:1b: e2:42:6b:ad: 2f:31:2d:24: d9:c2:76:2b: 53:5e:f4:d7: 8e:17:75:a9: 45:3a:68:a5'
  # contador = '01:00:00:00'
  # nonce = 'b6:9e:de:ac: 73:ee:44:50: d3:fa:9a:8e'
  
  # Genero la semilla aleatoria
  random.seed(0)
  contador = random.randint(0, 4294967295)
  contador = str(hex(contador)[2:].zfill(8))
